...
public class DbXmlManagerTest extends DdieditorTestCase {
	...
	public void query() throws Exception {
		PersistenceManager.getInstance().setWorkingResource(DdieditorTestCase.FULLY_DECLARED_NS_DOC);
	...
	public void getResources() throws Exception {
		PersistenceManager.getInstance().setWorkingResource(PersistenceManager.getInstance().RESOURCE_LIST_FILE);		
	...
	public void exportResource() throws Exception {
		...
		file.deleteOnExit();
		DbXmlManager.getInstance().exportResource(DdieditorTestCase.FULLY_DECLARED_NS_DOC,
				file);
